...
const PostModal: React.FC<PostModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-blue-950/90 bg-opacity-50 ">
      <form
        action=""
        className="w-2/3 flex flex-col  p-4 shadow-md bg-white rounded-md"
      >
        <h1 className="py-4 border-b border-gray-200 text-2xl text-center font-bold uppercase text-blue-400">
          Add a new Post
        </h1>
